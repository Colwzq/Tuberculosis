...
data = dict(
    ...
    train=dict(
        type="CocoDataset",
        ann_file="/home/colwzq/data/medical_datasets/TBX11K/annotations/json/all_trainval.json",
    ...
    test=dict(
        type="CocoDataset",
        ann_file="/home/colwzq/data/medical_datasets/TBX11K/annotations/json/TBX11K_trainval.json",
        img_prefix="/home/colwzq/data/medical_datasets/TBX11K/imgs/",
